                            ...
                            <form action="{{route('register')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="foto" type="file" class="form-control @error('foto') is-invalid @enderror" placeholder="Upload Foto" name="foto" value="{{old('foto')}}" required
                                            autocomplete="foto">
                                        @error('foto')
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-radio">
                                                <label class="form-check-label">
                                                    <input type="radio"
                                                        class="form-check-input  @error('jenis_kelamin') is-invalid @enderror "
                                                        name="jenis_kelamin" value="P" @if (old('jenis_kelamin'))
                                                        checked @endif> Perempuan
                                                </label>
                                            </div>
                                        </div>
                                    </div>
