...
<body>
    <div style="overflow: border: 1px solid #000; margin: 20px ; padding: 20px; width: 80%; background-color: none;">
        ...
        <h4 style="text-align: center;" > LAPORAN DATA PEMELIHARAAN BARANG</h4>
        ...
        <table align="center" style="border-collapse:collapse;">
            <thead>
                <tr>
                  ...
                  <th style="border:1px solid #000; text-align: center;padding: 3px; width: 20px; background-color: rgb(197, 197, 197);">TANGGAL PEMELIHARAAN</th>
                  ...
                  <th style="border:1px solid #000; text-align: center;padding: 3px; width: 20px; background-color: rgb(197, 197, 197);">STATUS</th>
                </tr>
              </thead>
              <tbody>
                  @foreach ($pemeliharaan as $data)
                   <tr>
                      ...
                      <td style="border:1px solid #000; text-transform: uppercase; text-align: left;padding-left: 12px; width: 140px;">{{date('d-m-Y',strtotime($data->tgl_pemeliharaan))}}</td>
                      <td style="border:1px solid #000; text-transform: uppercase; text-align: left;padding-left: 12px; width: 180px;">{{$data->user->nama}}</td>
                      <td style="border:1px solid #000; text-transform: uppercase; text-align: left;padding-left: 12px; width: 180px;">{{$data->barang->nama_barang}}</td>
                      <td style="border:1px solid #000; text-transform: uppercase; text-align: center;padding: 2px; width: 100px;">{{$data->jumlah}}</td>
                      <td style="border:1px solid #000; text-transform: uppercase; text-align: left;padding-left: 12px; width: 180px;">{!!$data->statusPemeliharaan!!}</td>
                   </tr>
                  @endforeach
              </tbody>
            </table>
