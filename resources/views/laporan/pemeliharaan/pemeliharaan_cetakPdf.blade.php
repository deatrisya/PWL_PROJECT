              ...
              <tbody>
                  @foreach ($pemeliharaan as $data)
                   <tr class="text-left">
                      ...
                      <td style="width: 140px;">{{date('d-m-Y',strtotime($data->tgl_pemeliharaan))}}</td>
                      <td style="width: 180px;">{{$data->user->nama}}</td>
                      <td style="width: 180px;">{{$data->barang->nama_barang}}</td>
                      <td class="text-center" style="padding: 2px; width: 100px;">{{$data->jumlah}}</td>
                      <td style="width: 180px;">{!!$data->statusPemeliharaan!!}</td>
                   </tr>
                  @endforeach
              </tbody>
            </table>
