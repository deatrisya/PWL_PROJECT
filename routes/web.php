...
Route::group(['middleware' => 'auth'], function(){
    ...
    //Laporan
    Route::get('laporan/brg_masuk',[LaporanPengadaanController::class,'index'])->name('laporanPengadaan');
    ...
    Route::get('laporan/brg_keluar',[LaporanPenyusutanController::class,'penyusutan'])->name('laporanPenyusutan');
